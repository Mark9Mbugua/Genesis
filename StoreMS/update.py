...
#select maximum id value from inventory(table in the database)
...
class Database:
    def __init__(self, master, *args, **kwargs):
        ...
        self.btn_add = Button(master, text="Update the database", width=25, height=2, bg="steelblue", fg="white", command=self.update)
    ...
    def search(self, *args, **kwargs):
        ...
        result = c.execute(sql, self.id_leb.get(), )# this is a tuple
        for r in result:
            self.n1 = r[1] #name
            self.n2 = r[2] #stock
            self.n3 = r[3] #cp
