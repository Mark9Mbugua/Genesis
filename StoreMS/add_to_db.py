...
class Database:
    def __init__(self, master, *args, **kwargs):
        ...
        self.btn_clear = Button(master, text="Clear all the Fields", width=25, height=2, bg="red", fg="white", command=self.clear_all)
        self.btn_clear.place(x=300, y=420)

        #textbox fot the logs
